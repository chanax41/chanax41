                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="left-content">
                            <br>
                            <h4>About us</h4>
                            <p>เกาะพะลวย อยู่ในหมู่ที่ 6 ของตำบลอ่างทอง อำเภอเกาะสมุย จังหวัดสุราษฎร์ธานี เป็นเกาะขนาดใหญ่เป็นอันดับที่สองรองจากเกาะวัวตาหลับซึ่งบางส่วนของเกาะอยู่ใน เขตอุทยานแห่งชาติหมู่เกาะอ่างทอง ประมาณครึ่งเกาะ เมื่อวันที่ 12 พฤศจิกายน พ.ศ. 2523 กรมอุทยาน ได้ประกาศหมู่เกาะอ่างทองเป็นอุทยานแห่งชาติ เป็นแห่งที่ 21 ของประเทศ ส่วนเหลือเป็นที่อยู่ในความดูแลของกรมธนารักษ์ กระทรวงการคลัง</p>
                            <div class="blue-button">
                    ...
                    <div class="col-md-7">
                    <iframe width="100%" height="400" src="https://www.youtube.com/embed/a7G3y0FMIwk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            ...
                            <div class="down-content">
                                ...
                                <p><span><strong><sup>$</sup>300.00</strong> - <strong><sup>$</sup>400.00</strong></span></p>

                                <div class="text-button">
                                    <a href="package-details.php">View More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="useful-links">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <ul>
                                    <li><a href="packages.php"><i class="fa fa-stop"></i>Packages</a></li>
